    ...
    async with aiohttp.ClientSession() as session:
        try:
            while True:
                ...
                await asyncio.sleep(0.5) # Thoda sa delay zaroori hai block hone se bachne ke liye
...
async def main():
    while True:
        clear()
        print("\033[1;32m" + "━"*45)
        print("\033[1;37m 🚀 \033[1;31mJERRY BOMBER TOOL\033[1;37m 🚀")
        print("\033[1;32m" + "━"*45)
        print("\033[1;37m DEVELOPER : \033[1;33mAB LEGEND JERRY")
